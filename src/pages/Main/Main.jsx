...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `화양지구 중심 주거 가치`,
    text2: `평택 화양지구 중심 입지의 브랜드 아파트<br/>
            쾌적한 단지 설계와 주거 환경`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `서평택 교통망 접근성`,
    text2: `서해안고속도로·평택제천고속도로 이용 편리<br/>
            수도권 및 산업벨트 이동 접근성`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img
              ...
              alt="평택 화양 서희스타힐스 메인 이미지"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox}>
              <div className={styles.mainImageTextSub}>
                브랜드 가치 서희스타힐스{" "}
                <span className={styles.greyText}>주거 프리미엄</span>
              </div>
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>화양지구의 새로운 주거 중심</div>
          ...
          <div className={styles.section}>
            <div className={styles.section1}>
              ...
              <div className={styles.text3}>
                - 평택 화양지구 중심 입지의 미래가치 주거단지<br />
                - 서해안고속도로·평택제천고속도로 등 광역 교통망 접근성<br />
                - 안중 생활권 인접 생활 편의시설 이용 가능<br />
                - 쾌적한 단지 설계와 주거 중심 커뮤니티 계획
              </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="평택 화양 서희스타힐스아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="평택 화양 서희스타힐스브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>평택 화양 서희스타힐스</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xwvwgvva"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="평택 화양 서희스타힐스오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              ...
              서희스타힐스 브랜드 프리미엄
              <br />
              <span className={styles.greyText1}>브랜드 주거 가치</span>
              <br />
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 평택 화양 서희스타힐스에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="평택 화양 서희스타힐스모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="평택 화양 서희스타힐스브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="평택 화양 서희스타힐스오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
