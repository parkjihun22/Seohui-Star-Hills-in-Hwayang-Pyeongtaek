...
<Helmet>
  <title>평택 화양 서희스타힐스 - 동·호수 배치</title>
  <meta
    name="description"
  ...
  <meta property="og:title" content="평택 화양 서희스타힐스 - 동·호수 배치" />
  <meta
...
<h1 className={styles.screenReaderOnly}>
  평택 화양 서희스타힐스 동·호수 배치
</h1>
<p className={styles.screenReaderOnly}>
  평택 화양 서희스타힐스의 동·호수 배치 정보를 안내하는 페이지입니다.
  단지 내 동별 위치와 세대 배치 구성을 확인하고 원하는 타입과 위치를 비교해보세요.
</p>
